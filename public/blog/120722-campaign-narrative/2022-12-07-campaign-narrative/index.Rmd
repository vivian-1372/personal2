...
```{r echo = FALSE, out.width = "95%", fig.cap = 'Source: CNN.'}
knitr::include_graphics("WA_8.png")
```
## Fast Facts 
...
```{r echo = FALSE, out.width = "95%", fig.cap = 'Source: CNN.'}
knitr::include_graphics("WA_redistricting.png")
```
...
knitr::include_graphics("WA_campaigns.png")
```
